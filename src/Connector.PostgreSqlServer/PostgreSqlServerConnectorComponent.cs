...
{
    [Component(PostgreSqlServerConstants.ProviderName, "Providers", ComponentType.Service, ServerComponents.ProviderWebApi, Components.Server, Components.DataStores, Isolation = ComponentIsolation.NotIsolated)]
    public sealed class PostgreSqlServerConnectorComponent : ServiceApplicationComponent<IServer>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostgreSqlServerConnectorComponent" /> class.
        /// </summary>
        ...
        public PostgreSqlServerConnectorComponent(ComponentInfo componentInfo) : base(componentInfo)
        {
            ...
            Container.Register(Component.For<PostgreSqlServerConnectorComponent>().Instance(this));
        ...
        public override void Start()
        {
            ...
            this.Log.LogInformation("PostgreSqlClient Registered");
